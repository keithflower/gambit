...
; File: "repo.c", produced by Gambit-C v4.7.0
(
407000
" repo"
(" repo")
...
___BEGIN_MOD1
___DEF_PRM(0,___G__20_repo,1)
___DEF_PRM(5,___G_repo_23_reset_2d_login_2d_info,3)
___DEF_PRM(7,___G_repo_23_set_2d_login_2d_info,10)
___DEF_PRM(1,___G_repo_23_get_2d_login_2d_info,13)
___DEF_PRM(6,___G_repo_23_save_2d_login_2d_info,22)
___END_MOD1
