...
;;;               Modified for Android devices by Keith Flower.

;; This program implements the "Gambit REPL" application for phone and tablet
...
;; Android - todo - this needs to return info from device
(define device-model (lambda () 'GenericAndroid))
    ...
    ((file)
     (with-exception-catcher
      (lambda (e)
        ...
        (repl))
      (lambda ()
        (delete-file (##path-expand name (current-directory)))))
     (back))))
...
<div class="repohead">
<div class="button1" onClick="window.Android.onWebViewEvent('event:back');">&#9664;</div>
</div>
      ...
      (list "<tr>"
            (if (pair? subtree)
                (list "<td class=\"repoget\"></td>\n"
                      "<td><div class=\"button1\" onClick=\"window.Android.onWebViewEvent('event:view:"
                      (url-encode name)
                      "');\">&#9654;</div></td>\n")
                (list "<td class=\"repoget\"><div class=\"button0\" onClick=\"window.Android.onWebViewEvent('event:get:"
                      (url-encode name)
                      "');\">Get</div></td>\n"
                      "<td><div class=\"button1\" onClick=\"window.Android.onWebViewEvent('event:view:"
                      (url-encode name)
...
<input type="button" class="bigbutton" value="Log in" onClick="window.Android.onWebViewEvent('event:login:'+encodeURIComponent(document.getElementById('username').value)+':'+encodeURIComponent(document.getElementById('password').value)+':'+encodeURIComponent(document.getElementById('rememberpass').value)+':');" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" class="bigbutton" value="Cancel" onClick="window.Android.onWebViewEvent('event:cancel');" />
...
<div class="widebutton" onClick="window.Android.onWebViewEvent('event:create-account');">Create an account</div><br/>
It's free!
</center>
